  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        slideDown: {
          from: { height: 0 },
          to: { height: 'var(--caster-collapsible-content-height)' },
        },
        slideUp: {
          from: { height: 'var(--caster-collapsible-content-height)' },
          to: { height: 0 },
        },
        enterFromRight: {
        ...
        open2D: {
          ...
          to: {
            width: 'var(--caster-accordion-content-width)',
            height: 'var(--caster-accordion-content-height)',
          },
        },
        close2D: {
          from: {
        ...
        swipeOut: {
          from: { transform: 'translateX(var(--caster-toast-swipe-end-x))' },
